					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-9 text-right">
								...
								<div>
									<fmt:message key="index.detalle.visita" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-9 text-right">
								...
								<div>
									<fmt:message key="index.datalle.grafico" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-9 text-right">
								...
								<div>
									<fmt:message key="index.detalle.usuario" />
								</div>
							</div>
						</div>
					</div>
				...
				<div class="table-responsive">
					<table
						...
						<tbody id="lista_user_logged">
							<%
								for ( Usuario usu : SessionListener.listaUsariosLogeados ){
							%>
							<tr>
